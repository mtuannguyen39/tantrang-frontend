...
export default function EditNewsPage() {
  ...
  async function fetchTnttData() {
    try {
      ...
      setDescription(tnttData.description);
      setCurrentThumbnailUrl(tnttData.thumbnail || "");
      setCategoryId(tnttData.categoryId);
      setIsFeatured(tnttData.isFeatured || false);
    } catch (error) {
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex justify-center items-center gap-4 pt-4">
              ...
              >
                {isSubmitting ? "Đang cập nhật...." : "Cập nhật tin tức TNTT"}
              </button>
              <button
                onClick={() => router.back()}
                type="button"
