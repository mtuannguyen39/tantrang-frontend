...
export default function CreateAdminModal({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-tr from-cyan-200 from- via-blue-400 via- to-lime-200 to-50 bg-opacity-50 flex items-center justify-center z-50">
